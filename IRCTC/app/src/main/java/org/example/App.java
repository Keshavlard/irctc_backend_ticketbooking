...
public class App {
    ...
    public static User userToLogin;
            ...
            switch (option){
                ...
                case 3:
                    if (userToLogin == null) {
                        ...
                        System.out.println("These are all the bookings for " + userToLogin.getName());
                    }
                    break;
                case 4:
                    ...
                    System.out.println("Select a train by typing the number corresponding to the train");
                    int trainIndex = scanner.nextInt();
                    if (trainIndex < 1 || trainIndex > trains.size()) {
                        System.out.println("Invalid selection. Please try again.");
                        break;
                    }
                    trainSelectedForBooking = trains.get(trainIndex - 1); // Index adjustment
                    break;
